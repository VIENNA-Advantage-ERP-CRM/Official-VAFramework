        ...
        this.gridSetup = function (grdFields, $container, name, mTab, gc) {
            ...
            for (var i = 0; i < mFields.length; i++) {
                ...
                //Date /////////
                    ...
                    oColumn.lookup = mField.getLookup();
                    // A location cell also shows the record's Additional Address
                    // Info (flat number etc.) in front of the address, like the
                    // location control does. A locator has no such qualifier.

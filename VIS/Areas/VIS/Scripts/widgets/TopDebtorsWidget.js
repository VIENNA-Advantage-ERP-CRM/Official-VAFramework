    ...
    VIS.TopDebtorsWidget = function () {
        ...
        function overdueLabel(daysOverdue) {
            if (!daysOverdue || daysOverdue <= 0) {
                return '<span style="font-size:12px;color:#748494;">' + lbl("VIS_NotYetOverdue", 'Not yet overdue') + '</span>';
            }
            return '<span style="font-size:12px;color:#748494;">' +
                daysOverdue + ' ' + lbl("VIS_DaysOverdue", 'days overdue') +
            '</span>';
        }
                    ...
                    '">' +
                        ...
                        '<div style="flex:1;min-width:0;">' +
                            '<div style="font-size:14px;font-weight:700;color:#102C3F;' +
                                ...
                                (r.customerName || '—') +
                            '</div>' +
                            '<div style="margin-top:2px;">' + overdueLabel(r.daysOverdue) + '</div>' +
                        '</div>' +
                        /* Amount + chip */

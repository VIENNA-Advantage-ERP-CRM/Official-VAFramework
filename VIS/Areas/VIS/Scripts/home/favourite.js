; (function (VIS, $) {
    ...
    function favMgr() {
        ...
        function addFavourite(barNode) {
            ...
            var favItemDiv = $('<div title="' + barNode.Name + '" data-id="' + id + '" data-action="' + barNode.Action + '" data-nodeid="' + barNode.NodeID + '" data-btn="action" class="vis-nm-fav-tile"><div class="vis-nm-fav-ico-w-txt"><span class="' + clsWinProPg + '"></span><div class="vis-nm-fav-tile-txt">' + barNode.Name + '</div></div><span class="vis vis-star-empty vis-nm-fav-icon-float" data-action="' + barNode.Action + '" data-id=' + barNode.NodeID + '  data-btn="remove"></span></div>');

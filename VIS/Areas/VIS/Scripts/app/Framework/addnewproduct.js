; (function (VIS, $) {
    ...
    function AddMProduct(windowNo) {
      var root = $('<div>');
        ...
        cancelBtn = root.find("#cancelBtn_" + self.windowNo);
        ...
        srchCtrlWrap.append(txtSearchKey.getControl().attr('placeholder', ' Required Unique Search key').attr("autocomplete", "off")).append('<label>' + VIS.Msg.getMsg("EnterSearchKey") + '</label>');
        ...
        upcCtrlWrap.append(txtUPC.getControl().attr('placeholder', ' ').attr('data-placeholder', '').attr("autocomplete", "off")).append('<label>' + VIS.Msg.getMsg("UPC_EAN") + '</label>');
        ...
        pTypeCtrlWrap.append(txtPType.getControl()).append('<label>' + VIS.Msg.getMsg("Product Type") + '</label>');
        ...
        PCatCtrlWrap.append(txtPCategory.getControl()).append('<label>' + VIS.Msg.getMsg("Product Category") + '</label>');
        ...
        taxCtrlWrap.append(txtTaxCategory.getControl()).append('<label>' + VIS.Msg.getMsg("Tax Category") + '</label>');
        ...
        attCtrlWrap.append(txtAttribute.getControl()).append('<label>' + VIS.Msg.getMsg("Attribute Set") + '</label>');

        txtPurchased = new VIS.Controls.VCheckBox("IsPurchased", false, false, true, VIS.Msg.getMsg("IsPurchased"), null, false);
        purCtrl.append(purCtrlWrap);
        purCtrlWrap.append(txtPurchased.getControl().addClass("vis-ec-col-lblchkbox"));

        txtSold = new VIS.Controls.VCheckBox("IsSold", false, false, true, VIS.Msg.getMsg("IsSold"), null, false);
        soldCtrl.append(soldCtrlWrap);
        soldCtrlWrap.append(txtSold.getControl().addClass("vis-ec-col-lblchkbox"));

        txtStocked = new VIS.Controls.VCheckBox("IsStocked", false, false, true, VIS.Msg.getMsg("IsStocked"), null, false);
        ...
        function events() {
            ...
            cancelBtn.on(VIS.Events.onClick, function () {
                dispose();
                clear();
            });

            txtSearchKey.fireValueChanged = function () {
                AddRemoveMandatory(txtSearchKey);
            };
            txtName.fireValueChanged = function () {
                AddRemoveMandatory(txtName);
            };
            txtUOM.fireValueChanged = function () {
                AddRemoveMandatory(txtUOM);
            };
            txtPType.fireValueChanged = function () {
                AddRemoveMandatory(txtPType);
            };
            txtPCategory.fireValueChanged = function () {
        ...
        function dispose() {
            ...
            okBtn = null;
            if (cancelBtn)
                cancelBtn.off(VIS.Events.onClick);
            cancelBtn = null;
            txtName = null;
            txtSearchKey = null;
            txtUOM = null;
